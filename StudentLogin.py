...
def branch_courses(branch_no, student_courses):
    cse_courses = ["Machine Learning", "Web Development",
    ...
    civil = ["Construction Management", "C++ Programming",
    ...
    if selected_course == 5:
        ...
        if all_courses[branch_no-1][selected_course-1] not in student_courses:
            print("Your are successfully enrolled in {}".format(
                all_courses[branch_no-1][selected_course-1]))
